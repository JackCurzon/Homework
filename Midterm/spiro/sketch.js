...
var osc = new Array(NUMSINES); // these will make sound

// play with these to get a sense of what's going on:
var fund = .005; // the speed of the central sine
var ratio = 100; // what multiplier for speed is each additional sine?
var alpha = 50; // how opaque is the tracing system

var trace = false; // are we tracing?

function preload() {
  mySound = loadSound('data/rain.m4a');
}
...
function setup()
{
  ...
  for (i = 0; i<sines.length; i++)
  {
    ...
    osc[i] = new p5.Oscillator(); // this initializes the oscillators
    osc[i].setType('sine');
